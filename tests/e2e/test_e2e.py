...
from playwright.sync_api import expect  # Import the expect function from Playwright for browser automation
import pytest
...
def test_calculator_add(page, fastapi_server):
    ...
    expect(page.locator('#result')).to_have_text('Calculation Result: 15') # The expected text should match the actual output from the application
